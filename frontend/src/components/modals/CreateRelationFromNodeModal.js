...
export const CreateRelationFromNodeModal = ({ open, onOpenChange, sourceId, targetId }) => {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <Select
                            ...
                            onValueChange={(val) => setFormData({...formData, joinType: val})}
                        >
                    ...
                    <div>
                        <Label htmlFor="relation2">Relation2 (SQL amb schema complet)</Label>
                        <Textarea
                            id="relation2"
