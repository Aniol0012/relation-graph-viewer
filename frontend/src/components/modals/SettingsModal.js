...
export const SettingsModal = ({ open, onOpenChange }) => {
  ...
  const handleImmediateColorChange = (joinType, color) => {
    ...
    updateSettings({
      joinColors: { ...localSettings.joinColors, [joinType]: color },
    });
  };
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Mostra l'ID de la vista al node
                    </p>
                  </div>
                  <Switch
                    checked={localSettings.showViewId}
                    onCheckedChange={(checked) =>
                      handleImmediateChange("showViewId", checked)
                    }
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Mostra el nom sota l'alias
                    </p>
                  </div>
                  <Switch
                    checked={localSettings.showAlias}
                    onCheckedChange={(checked) =>
                      handleImmediateChange("showAlias", checked)
                    }
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mb-2">
                    Caràcters: {localSettings.maxNodeNameLength}
                  </p>
                  <Slider
                    value={[localSettings.maxNodeNameLength]}
                    onValueChange={([val]) =>
                      handleLocalChange("maxNodeNameLength", val)
                    }
                    min={10}
                    max={40}
                    step={1}
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      handleImmediateChange("nodeSize", val)
                    }
                  >
                    <SelectTrigger
                      className="mt-1"
                      data-testid="select-node-size"
                    >
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="space-y-4 pt-4 border-t">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Etiqueta a les arestes
                    </p>
                  </div>
                  <Switch
                    checked={localSettings.showEdgeLabels}
                    onCheckedChange={(checked) =>
                      handleImmediateChange("showEdgeLabels", checked)
                    }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleImmediateChange("animatedEdges", checked)
                    }
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(val) =>
                      handleImmediateChange("edgeStyle", val)
                    }
                  >
                    <SelectTrigger
                      className="mt-1"
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      ...
                      style={{
                        backgroundColor:
                          localSettings.joinColors?.[key] || "#71717A",
                      }}
                    />
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleImmediateColorChange(key, e.target.value)
                    }
            ...
            <TabsContent value="layout" className="space-y-6 mt-0">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    handleImmediateChange("layoutDirection", val)
                  }
                >
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mb-2">
                  {localSettings.nodeSpacing}px
                </p>
                <Slider
                  value={[localSettings.nodeSpacing]}
                  onValueChange={([val]) =>
                    handleLocalChange("nodeSpacing", val)
                  }
                  min={40}
                  max={200}
                  step={10}
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mb-2">
                  {localSettings.levelSpacing}px
                </p>
                <Slider
                  value={[localSettings.levelSpacing]}
                  onValueChange={([val]) =>
                    handleLocalChange("levelSpacing", val)
                  }
                  min={60}
                  max={300}
                  step={10}
